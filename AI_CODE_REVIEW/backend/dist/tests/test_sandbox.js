...
async function testSandbox() {
    ...
    const res1 = await (0, sandbox_1.executeCode)('javascript', 'console.log("Hello Sandbox!");');
    ...
    const res2 = await (0, sandbox_1.executeCode)('python', 'print("Start")\na = 10\nb = 0\nc = a / b\nprint("End")');
    ...
    const res3 = await (0, sandbox_1.executeCode)('python', 'import time\nwhile True:\n    pass');

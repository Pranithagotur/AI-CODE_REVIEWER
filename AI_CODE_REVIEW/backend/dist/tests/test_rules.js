...
console.log('\n[TESTING JAVASCRIPT]');
const jsViolations = (0, ruleEngine_1.runStaticRules)('javascript', buggyJsCode);
console.log(JSON.stringify(jsViolations, null, 2));
console.log('\n[TESTING PYTHON]');
const pyViolations = (0, ruleEngine_1.runStaticRules)('python', buggyPythonCode);
console.log(JSON.stringify(pyViolations, null, 2));
console.log('\n[TESTING C++]');
const cppViolations = (0, ruleEngine_1.runStaticRules)('cpp', buggyCppCode);
